...
<section id="events" class="section-black module content" >
    <div class=" container">
        <!--<div class="row">
            ...
            <div class="col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1 title2"> 
                <?php
                            ...
                            <li style="margin: 0px 10px;" class="item">
                                <div class="thumbnail">
                                  ...
                                  <a href="<?php echo $q->quote_url; ?>" rel="prettyPhoto">
									  ...
									  <iframe width="260" height="210" src="<?php echo $q->quote_url; ?>" frameborder="0" allowfullscreen></iframe>
                                  </a>
                                </div>
                                <div class="caption">
                                  <h4><?php if($this->session->userdata('lang') == 'arabic') echo $q->quote_title_ar; else echo $q->quote_title; ?></h4>
...
<section class="section-orange module parallax parallax-3">
    <div class=" container">
        <!-- <div class="row">
			...
			<div class="row">
            <div class="col-md-6 col-md-offset-3 col-xs-8 col-xs-offset-2 <?php if($this->session->userdata('lang') == 'arabic') { echo ' col-md-push-3 col-xs-push-2'; } ?> contact-form">
                <div class="yellow"><?php echo $this->lang->line('contact_msg'); ?></div>
				<i class="fa fa-envelope-o yellow"></i> <a  href="mailto:info@ibnabbass.com ">info@ibnabbass.com</a>
                <?php echo validation_errors(); ?>
                <?php echo form_open('home/home_page/send_message'); ?>
                    <div class="form-group">
                      <label for="contact-name"><?php echo $this->lang->line('contact_name'); ?></label>
                      <input type="text" name="name" class="contact-name" id="contact-name">
                    </div>
                    <div class="form-group">
                      <label for="contact-email"><?php echo $this->lang->line('contact_mail'); ?></label>
                      <input type="text" name="email" class="contact-email" id="contact-email">
                    </div>
                    <div class="form-group">
                      <label for="contact-message"><?php echo $this->lang->line('contact_message'); ?></label>
                      <textarea name="message" class="contact-message" id="contact-message"></textarea>
                    </div>
